...
### Added
- Undo/redo support for parameter dashboard, remapping editor, and scenario editor
- `/push_remote` skill for release-aware commits with automatic changelog tracking
- `/add-test` skill for generating test scaffolding
